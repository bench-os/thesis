...
% En utilisant le PSLab board, nous pouvons mesurer l'intervalle de temps entre un flanc descendant et une flanc montant sur le GPIO.
% Cet intervalle représente le context switch étant donné qu'une task n'a la main mise.
...
\begin{lstlisting}[style=CStyle, language=python, label={lst:pslab-script-code}, caption={Call to the PSLab Python library}]
  while True:
