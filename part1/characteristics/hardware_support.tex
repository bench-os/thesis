...
Instead Class-0 devices are usually used bare metal. %Explain bare metal?
...
% This introduction doesnt explain any problematic, we should add a sentence to explain that
