...
\begin{itemize}
  ...
  \item Is it possible to implement a benchmarking framework aware of the RTOS that could give usefull metrics such as the memory usage or the power consumption? % TODO Reformulate this question
\end{itemize}
